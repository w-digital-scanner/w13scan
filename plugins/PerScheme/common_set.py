...
class W13SCAN(PluginBase):
    ...
    def generate(self):
        payloads = [{'path': '/core', 'tag': 'ELF', 'content-type': '', 'content-type_no': ''},
                    ...
                    {'path': '/manager/html', 'tag': '', 'content-type': '', 'content-type_no': ''},
                    {'path': '/admin.jsp', 'tag': '', 'content-type': '', 'content-type_no': ''},
                    {'path': '/admin.php', 'tag': '', 'content-type': '', 'content-type_no': ''},
                    {'path': '/admin.do', 'tag': '', 'content-type': '', 'content-type_no': ''},
                    {'path': '/admin.html', 'tag': '', 'content-type': '', 'content-type_no': ''},
                    {'path': '/login.php', 'tag': 'type="password"', 'content-type': '', 'content-type_no': ''},
                    {'path': '/login.do', 'tag': 'type="password"', 'content-type': '', 'content-type_no': ''},
                    ...
                    {'path': '/INSTALL.TXT', 'tag': '', 'content-type': 'text/plain', 'content-type_no': ''},
                    {'path': '/install.sh', 'tag': '', 'content-type': '', 'content-type_no': ''},
                    {'path': '/deploy.sh', 'tag': '', 'content-type': '', 'content-type_no': ''},
                    {'path': '/upload.sh', 'tag': '', 'content-type': '', 'content-type_no': ''},
                    {'path': '/setup.sh', 'tag': '', 'content-type': '', 'content-type_no': ''},
                    {'path': '/backup.sh', 'tag': '', 'content-type': '', 'content-type_no': ''},
                    {'path': '/rsync.sh', 'tag': '', 'content-type': '', 'content-type_no': ''},
                    {'path': '/sync.sh', 'tag': '', 'content-type': '', 'content-type_no': ''},
                    {'path': '/test.sh', 'tag': '', 'content-type': '', 'content-type_no': ''},
                    {'path': '/run.sh', 'tag': '', 'content-type': '', 'content-type_no': ''},
                    {'path': '/app.cfg', 'tag': '', 'content-type': '', 'content-type_no': ''},
