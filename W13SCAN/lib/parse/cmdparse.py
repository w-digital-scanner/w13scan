...
def cmd_line_parser(argv=None):
    ...
    parser.add_argument("--level", dest="level", type=int, default=1, choices=list(range(1, 6)),
    ...
    proxy.add_argument("-s", "--server-addr", dest="server_addr",
                       help="server addr format:(ip:port) default:127.0.0.1:7778", default="127.0.0.1:7778")
    ...
    target.add_argument("-r", "--from-json", dest="from_json", help="Load target from the json object")
